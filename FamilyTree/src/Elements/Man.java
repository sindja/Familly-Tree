 ...
 * @author Milan
 */
public class Man extends GroupFigure {
    ...
    public Man() {
        super();
        RectangleFigure r1 = new RectangleFigure(new Point(0, 0), new Point(70, 20));
    ...
    public void setColor(int x, int y, int z) {
        ...
        while (k.hasMoreElements()) {
            ...
            if (n instanceof RectangleFigure) {
